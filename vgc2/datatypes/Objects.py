...
from vgc2.datatypes.Constants import MOVE_MED_PP, MAX_HIT_POINTS
from vgc2.datatypes.Types import PkmType, PkmStatus, N_STATS, N_ENTRY_HAZARD, PkmStat, WeatherCondition, \
    PkmEntryHazard
