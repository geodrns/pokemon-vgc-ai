...
from vgc2.datatypes.Constants import DEFAULT_PKM_N_MOVES, DEFAULT_PARTY_SIZE, TYPE_CHART_MULTIPLIER, DEFAULT_N_ACTIONS
from vgc2.datatypes.Objects import GameState, PkmTeam
from vgc2.datatypes.Types import PkmStat, PkmType, WeatherCondition
...
class GUIPlayer(BattlePolicy):
    ...
    class App(CTk):
        def __init__(self, *args, **kwargs):
            ...
            # self.iconbitmap(r"vgc2/ux/vgc_v2_01_Uw5_icon.ico")
