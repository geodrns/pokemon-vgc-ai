...
from vgc2.datatypes.Constants import MAX_HIT_POINTS, MOVE_MAX_PP
from vgc2.datatypes.Objects import PkmMove, PkmTemplate, PkmFullTeam
from vgc2.datatypes.Types import WeatherCondition, PkmStatus, MAX_STAGE, PkmEntryHazard
